...
flags.DEFINE_string(
    "coco_path", "/Volumes/Elements/data/coco_dataset/coco", "resize images to"
)
flags.DEFINE_string("image_path", "images/val2017", "path to image val")
flags.DEFINE_string(
    "anno_path_val", "../data/dataset/val2017.txt", "path to classes file"
)
        ...
        for image_path in image_paths:
            ...
            if image_inds in data:
                ...
                for key, value in objects.items():
                    ...
                    annotation += " " + ",".join(
                        [str(xmin), str(ymin), str(xmax), str(ymax), str(class_ind)]
                    )
            else:
                continue
            f.write(annotation + "\n")
